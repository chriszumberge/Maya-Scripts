...
#Create a window and make it resizable, add a flag for menu
mc.window("poseWindow", t="The Pose Saver", wh=(500, 500), s=True, menuBar=True)
#Create a menu with label
mc.menu(l="Instructions")
#Create a menu item for the menu, with text
mc.menuItem("Select objects to bookmark, then click any Symbol Button under \"Pose Types\" tab to specify what type of bookmark to save.", bld=True)

mc.menu(l="Contact Me...")
contact = "Contact: chriszumberge@gmail.com"
mc.menuItem("Click for my contact info...", bld=True, c="mc.headsUpMessage(contact)\nprint contact")
...
def createShelfButton_body(targetShelf_body):
    ...
    #If the condition above is not true, then run the following commands    
        ...
        if pd_body == "Save It!":
            ...
            #Create file, remember it's being sourced as MEL
            filePathName = (usd + pd_body_name + ".mel")
            #w for writable, a for append
